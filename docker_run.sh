...
nvidia-docker run --name pytorch_jupyter -it --rm -v $NOTEBOOKS_PATH:/notebooks -v /home/student/humam/:/repository -v /home/student/Data/:/repository/Data -e NB_UID=1000 -e NB_GID=1000 -e VNC_SERVER_PASSWORD=password -p 8888:8888 --runtime=nvidia -p 6006:6006 -p 5900:5900 humamamouri/torch-gpu:latest
